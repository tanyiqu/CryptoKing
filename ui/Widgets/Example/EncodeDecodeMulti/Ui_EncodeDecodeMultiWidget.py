...
# Form implementation generated from reading ui file 'x:\Python\_Project\CryptoKing\ui\Widgets\Example\EncodeDecodeMulti\EncodeDecodeMultiWidget.ui'
#
...
class Ui_EncodeDecodeMultiWidget(object):
    def setupUi(self, EncodeDecodeMultiWidget):
        EncodeDecodeMultiWidget.setObjectName("EncodeDecodeMultiWidget")
        EncodeDecodeMultiWidget.resize(758, 513)
        EncodeDecodeMultiWidget.setMinimumSize(QtCore.QSize(90, 40))
        self.verticalLayout = QtWidgets.QVBoxLayout(EncodeDecodeMultiWidget)
        self.verticalLayout.setObjectName("verticalLayout")
        self.widget_3 = QtWidgets.QWidget(EncodeDecodeMultiWidget)
...
"}")
        ...
        self.widget = QtWidgets.QWidget(EncodeDecodeMultiWidget)
...
"}")
        ...
        self.widget_2 = QtWidgets.QWidget(EncodeDecodeMultiWidget)
...
"")
        ...
        self.retranslateUi(EncodeDecodeMultiWidget)
        QtCore.QMetaObject.connectSlotsByName(EncodeDecodeMultiWidget)
        EncodeDecodeMultiWidget.setTabOrder(self.txt_left, self.txt_right)
        EncodeDecodeMultiWidget.setTabOrder(self.txt_right, self.btn_encode)
        EncodeDecodeMultiWidget.setTabOrder(self.btn_encode, self.btn_decode)

    def retranslateUi(self, EncodeDecodeMultiWidget):
        _translate = QtCore.QCoreApplication.translate
        EncodeDecodeMultiWidget.setWindowTitle(_translate("EncodeDecodeMultiWidget", "Form"))
        self.combo_method.setItemText(0, _translate("EncodeDecodeMultiWidget", "Choose1"))
        self.combo_method.setItemText(1, _translate("EncodeDecodeMultiWidget", "Choose2"))
        self.txt_left.setPlaceholderText(_translate("EncodeDecodeMultiWidget", "Input:"))
        self.txt_right.setPlaceholderText(_translate("EncodeDecodeMultiWidget", "Output:"))
        self.btn_encode.setText(_translate("EncodeDecodeMultiWidget", "编码"))
        self.btn_decode.setText(_translate("EncodeDecodeMultiWidget", "解码"))

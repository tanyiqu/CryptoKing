...
# Form implementation generated from reading ui file 'x:\Python\_Project\CryptoKing\ui\Widgets\Example\EncodeOnly\EncodeOnlyWidget.ui'
#
...
class Ui_EncodeOnlyWidget(object):
    def setupUi(self, EncodeOnlyWidget):
        EncodeOnlyWidget.setObjectName("EncodeOnlyWidget")
        EncodeOnlyWidget.resize(670, 513)
        EncodeOnlyWidget.setMinimumSize(QtCore.QSize(90, 40))
        self.verticalLayout = QtWidgets.QVBoxLayout(EncodeOnlyWidget)
        self.verticalLayout.setObjectName("verticalLayout")
        self.widget = QtWidgets.QWidget(EncodeOnlyWidget)
...
"}")
        ...
        self.widget_2 = QtWidgets.QWidget(EncodeOnlyWidget)
...
"")
        ...
        self.retranslateUi(EncodeOnlyWidget)
        QtCore.QMetaObject.connectSlotsByName(EncodeOnlyWidget)
        EncodeOnlyWidget.setTabOrder(self.txt_left, self.txt_right)
        EncodeOnlyWidget.setTabOrder(self.txt_right, self.btn_encode)

    def retranslateUi(self, EncodeOnlyWidget):
        _translate = QtCore.QCoreApplication.translate
        EncodeOnlyWidget.setWindowTitle(_translate("EncodeOnlyWidget", "Form"))
        self.txt_left.setPlaceholderText(_translate("EncodeOnlyWidget", "Input:"))
        self.txt_right.setPlaceholderText(_translate("EncodeOnlyWidget", "Output:"))
        self.btn_encode.setText(_translate("EncodeOnlyWidget", "计算"))
